...
export type GetAnimeFromIdQueryVariables = Exact<{
  id?: Maybe<Scalars['Int']>;
}>;


export type GetAnimeFromIdQuery = (
  { __typename?: 'Query' }
  & { Media?: Maybe<(
    { __typename?: 'Media' }
    & Pick<Media, 'favourites' | 'averageScore' | 'meanScore' | 'bannerImage' | 'description' | 'genres' | 'episodes' | 'type' | 'format' | 'status' | 'season' | 'seasonYear' | 'duration' | 'source'>
    & { title?: Maybe<(
      { __typename?: 'MediaTitle' }
      ...
      & { edges?: Maybe<Array<Maybe<(
        ...
        & { node?: Maybe<(
          { __typename?: 'Review' }
          & Pick<Review, 'id' | 'summary' | 'body' | 'rating' | 'ratingAmount'>
        )> }
      )>>> }
    )>, characters?: Maybe<(
      { __typename?: 'CharacterConnection' }
      & { edges?: Maybe<Array<Maybe<(
        { __typename?: 'CharacterEdge' }
        & Pick<CharacterEdge, 'role'>
        & { node?: Maybe<(
          { __typename?: 'Character' }
          & Pick<Character, 'id'>
          & { name?: Maybe<(
            { __typename?: 'CharacterName' }
            & Pick<CharacterName, 'first' | 'middle' | 'last' | 'full' | 'native' | 'userPreferred'>
          )>, image?: Maybe<(
            { __typename?: 'CharacterImage' }
...
export type GetPopularCharactersQueryVariables = Exact<{
  page?: Maybe<Scalars['Int']>;
  perPage?: Maybe<Scalars['Int']>;
}>;


export type GetPopularCharactersQuery = (
  { __typename?: 'Query' }
  & { Page?: Maybe<(
    { __typename?: 'Page' }
    & { characters?: Maybe<Array<Maybe<(
      { __typename?: 'Character' }
      & Pick<Character, 'id' | 'description'>
      & { name?: Maybe<(
        { __typename?: 'CharacterName' }
        & Pick<CharacterName, 'first' | 'middle' | 'last' | 'full' | 'native' | 'userPreferred'>
      )>, image?: Maybe<(
...
export type GetTrendingAnimesQueryVariables = Exact<{
  page?: Maybe<Scalars['Int']>;
  perPage?: Maybe<Scalars['Int']>;
  seasonYear?: Maybe<Scalars['Int']>;
}>;
...
export type GetTrendingAnimesQuery = (
  { __typename?: 'Query' }
  & { Page?: Maybe<(
    { __typename?: 'Page' }
    & { media?: Maybe<Array<Maybe<(
      { __typename?: 'Media' }
      & Pick<Media, 'id' | 'genres'>
      & { title?: Maybe<(
        { __typename?: 'MediaTitle' }
...
export const GetAnimeFromIdDocument = gql`
...
/**
 * __useGetAnimeFromIdQuery__
 *
 * To run a query within a React component, call `useGetAnimeFromIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAnimeFromIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAnimeFromIdQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetAnimeFromIdQuery(baseOptions?: Apollo.QueryHookOptions<GetAnimeFromIdQuery, GetAnimeFromIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAnimeFromIdQuery, GetAnimeFromIdQueryVariables>(GetAnimeFromIdDocument, options);
      }
export function useGetAnimeFromIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAnimeFromIdQuery, GetAnimeFromIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAnimeFromIdQuery, GetAnimeFromIdQueryVariables>(GetAnimeFromIdDocument, options);
        }
export type GetAnimeFromIdQueryHookResult = ReturnType<typeof useGetAnimeFromIdQuery>;
export type GetAnimeFromIdLazyQueryHookResult = ReturnType<typeof useGetAnimeFromIdLazyQuery>;
export type GetAnimeFromIdQueryResult = Apollo.QueryResult<GetAnimeFromIdQuery, GetAnimeFromIdQueryVariables>;
export const GetPopularCharactersDocument = gql`
...
/**
 * __useGetPopularCharactersQuery__
 *
 * To run a query within a React component, call `useGetPopularCharactersQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPopularCharactersQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPopularCharactersQuery({
 *   variables: {
 *      page: // value for 'page'
 ...
 * });
 */
export function useGetPopularCharactersQuery(baseOptions?: Apollo.QueryHookOptions<GetPopularCharactersQuery, GetPopularCharactersQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPopularCharactersQuery, GetPopularCharactersQueryVariables>(GetPopularCharactersDocument, options);
      }
export function useGetPopularCharactersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPopularCharactersQuery, GetPopularCharactersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPopularCharactersQuery, GetPopularCharactersQueryVariables>(GetPopularCharactersDocument, options);
        }
export type GetPopularCharactersQueryHookResult = ReturnType<typeof useGetPopularCharactersQuery>;
export type GetPopularCharactersLazyQueryHookResult = ReturnType<typeof useGetPopularCharactersLazyQuery>;
export type GetPopularCharactersQueryResult = Apollo.QueryResult<GetPopularCharactersQuery, GetPopularCharactersQueryVariables>;
export const GetTrendingAnimesDocument = gql`
...
/**
 * __useGetTrendingAnimesQuery__
 *
 * To run a query within a React component, call `useGetTrendingAnimesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetTrendingAnimesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetTrendingAnimesQuery({
 *   variables: {
 *      page: // value for 'page'
 *      perPage: // value for 'perPage'
 ...
 * });
 */
export function useGetTrendingAnimesQuery(baseOptions?: Apollo.QueryHookOptions<GetTrendingAnimesQuery, GetTrendingAnimesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetTrendingAnimesQuery, GetTrendingAnimesQueryVariables>(GetTrendingAnimesDocument, options);
      }
export function useGetTrendingAnimesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetTrendingAnimesQuery, GetTrendingAnimesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetTrendingAnimesQuery, GetTrendingAnimesQueryVariables>(GetTrendingAnimesDocument, options);
        }
export type GetTrendingAnimesQueryHookResult = ReturnType<typeof useGetTrendingAnimesQuery>;
export type GetTrendingAnimesLazyQueryHookResult = ReturnType<typeof useGetTrendingAnimesLazyQuery>;
export type GetTrendingAnimesQueryResult = Apollo.QueryResult<GetTrendingAnimesQuery, GetTrendingAnimesQueryVariables>;
